...
def calculate_score(player_hand):
    ...
    if len(player_hand) == 2 and score == 21:
        return 0
    elif 11 in player_hand and score > 21:
...
def play_game():
    ...
    while not is_game_over:
        ...
        print(f"Computer's cards: {ai_cards[0]}.")

        if user_score or ai_score == 0 or user_score > 21:
            is_game_over = True
        else:
    ...
    print(f"AI's final hand is: {ai_cards}, final score: {ai_score}.")
